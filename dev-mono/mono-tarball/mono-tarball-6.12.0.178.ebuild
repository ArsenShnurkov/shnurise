...
SRC_URI="https://download.mono-project.com/sources/mono/preview/mono-${PV}.tar.xz"
...
# sys-devel/binutils-2.38 is for dwarf-5 format
...
PATCHES=(
	...
	"${FILESDIR}"/mono-6.12.0.122-disable-automagic-ccache.patch
)
