...
#https://github.com/freeorion/freeorion/releases/download/v0.4.6-RC2/FreeOrion_v0.4.6-RC2_2016-09-16.49f9123_Source.tar.gz
SRC_URI="https://github.com/${PN}/${PN}/releases/download/v0.4.6-RC2/FreeOrion_v0.4.6-RC2_2016-09-16.49f9123_Source.tar.gz -> ${P}.tar.gz"
RESTRICT="mirror"
