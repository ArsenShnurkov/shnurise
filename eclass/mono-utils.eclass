...
# $Header: $
# @ECLASS: mono-utils.eclass
# @MAINTAINER: arsen.shnurkov@gmail.com
# @BLURB: common settings and functions for mono and dotnet related packages
# @DESCRIPTION:
# The mono-utils eclass contains common environment settings that are useful for
# mono packages.

EAPI="5"

inherit eutils versionator mono-env git-2
